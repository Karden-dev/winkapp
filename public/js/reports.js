...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const fetchReports = async (date) => {
        ...
        try {
            ...
            const res = await axiosInstance.get('/reports', { params: { date } });
            allReports = res.data;
    ...
    reportsTableBody?.addEventListener('click', async (e) => {
        ...
        if (button) {
            ...
            try {
                const res = await axiosInstance.get('/reports/detailed', { params: { date: reportDate, shopId } });
    ...
    if (processStorageBtn) {
        processStorageBtn.addEventListener('click', async () => {
            ...
            try {
                const response = await axiosInstance.post('/reports/process-storage', { date });
    ...
    if (consolidateBtn) {
        consolidateBtn.addEventListener('click', async () => {
            ...
            try {
                const response = await axiosInstance.post('/reports/consolidate-balances', { date });
                showNotification(response.data.message, 'success');
