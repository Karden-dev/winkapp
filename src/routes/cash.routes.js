...
// AJOUTÉ : Route pour récupérer une transaction par son ID
router.get('/transactions/:id', authMiddleware.verifyToken, authMiddleware.isAdmin, cashController.getTransactionById);
...
// AJOUTÉ : Route pour supprimer une transaction
router.delete('/transactions/:id', authMiddleware.verifyToken, authMiddleware.isAdmin, cashController.deleteTransaction);
